...
ix=285#input('Enter X:')
iy=-375#input('Enter Y:')
...
def filter_step(old_pose, motor_ticks):
        ...
        if  stlne>-0.020 and stlne<0.020:
                ...
                avg = r*ticks_to_cm
                #print i
                return((avg)*cos(old_pose[2])+old_pose[0],(avg)*sin(old_pose[2])+old_pose[1],old_pose[2])
        ...
        '''elif stlne > 0 and stlne < 0.010:#left turn
        ...
        elif stlne < 0 and stlne > -0.010:#right turn
                #print("strlne :"+str(stlne))
                #print (l-r)

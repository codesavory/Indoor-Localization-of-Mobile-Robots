...
def erun():
    ...
    while True:
        with ReadChar() as rc:
            char = rc
	#print(ord(char))
	print("Leftwheel:",-ad1.encoder[2].position)#left motor
	print("Rightwheel:",ad1.encoder[0].position)#right motor
	f.write(str(-ad1.encoder[2].position)+" "+str(ad1.encoder[0].position)+"\n")
